    ...
    <header>
        <div class="header-primary-container container">
            ...
            <div class="logo-wrapper">
                <h1 class="logo">
                    <a class="display-only-desk" href="https://www.cafeodebrecht.com.br/" title="Café Odebrecht">
                        <picture>
                ...
                <div class="header-gutter header-gutter--3">
                    <div class="mobile-search">
                        <section class="form-search">
                            <form id="search_mini_form" action="https://www.cafeodebrecht.com.br/catalogsearch/result/" method="get">
        ...
        <div class="nav-container">
            <nav id="nav">
                <ul class="cat level1">
                    ...
                    <li class="item7-1 parent"><a href="https://www.cafeodebrecht.com.br/acessorios.html">Acessórios</a></li>
                </ul>
            </nav>
        </div>
    </div>
